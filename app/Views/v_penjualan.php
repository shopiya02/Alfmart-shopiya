...
<div class="wrapper">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                     ...
                     <tr>
                      ...
                      <td class="text-center"><?= $value['qty'] ?> <?= $value['options']['nama_satuan'] ?></td></td>
 ...
 <input name="kembalian" id="kembalian" class="form-control form-control-lg text-right text-primary" readonly>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>SHOPIYAA <a href="https://adminlte.io"></a></strong> 
  </footer>
</div>
<!-- ./wrapper -->
